...
export class AlumnosScreenComponent  implements OnInit{
  ...
  public mostrarColumnas(){
    if(this.rol == "administrador"){
      this.displayedColumns = ['matricula', 'nombre', 'email', 'fecha_nacimiento', 'curp', 'rfc', 'telefono', 'editar', 'eliminar'];
    }else if(this.rol == "maestro" || this.rol == "alumno"){
      this.displayedColumns = ['matricula', 'nombre', 'email', 'fecha_nacimiento', 'curp', 'rfc', 'telefono'];
    }
  }
}
